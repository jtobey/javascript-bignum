// XXX Broken by API change.

    //load("lib/decimal.js"); var Decimals = implementExactDecimals({interfaces:interfaces,nativeToExactInteger:Integers.nativeToExactInteger,isDefaultDecimal:true});
/*
    Function: implementExactDecimals(plugins, args)
    ...
    *numerator*.  <divideReduced> returns the result of dividing
