...
var isFinite           = pluginApi.isFinite;
var isInfinite         = pluginApi.isInfinite;
var isNaN              = pluginApi.isNaN;
...
ExactDecimal.prototype.valueOf = function() {
    var n = this._n;
    var e = +this._e;
    var ret = n * natPow(10, e);
    if (!_isNaN(ret))
        return ret;
    if (isNegative(n))
        return -natExp(log(negate(n)) + LN10 * e);
    return natExp(log(n) + LN10 * e);
}
...
var toDecimal = pluginApi.toDecimal;
if (!toDecimal) {
...
ExactDecimal.prototype.toExponential = function(digits) {
    ...
    return s + numberToString(e);
};

// This exp10 takes an exact power.
function ED_exp10(ed, p) {
...
if (isDefaultDecimal) {
    // XXX want to override EINative and BigInteger impls for negative p.
...
// 1234e-3 (1.234) toFixed(2)  s.b. 1.23
// digits=2, e=-3, newDigits=-1, s=1230, want=1.23
// 1234e1 (12340) toFixed(-3) s.b. 12000
// digits=-3, e=1, newDigits=-2, s=1200, want=12000
