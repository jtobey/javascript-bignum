...
*/
// Where schemeNumber.js calls implementBigInteger, do this instead:
// load('lib/javaBigInteger.js'); var Integers = implementJavaBigInteger(plugins, java.math.BigInteger);
function implementJavaBigInteger(plugins, BigInteger) {
    "use strict";
